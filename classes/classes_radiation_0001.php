    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="subContainer">
                ...
                <div id="content">
                  <h1>Training Classes - Radiation Safety</h1>
        
        <h2 id="initial_radiation_safety">On-Site and Initial Radiation Safety for New Radiation Workers</h2>
        ...
        <p>Contact (859) 323-6276 for more information.</p>
        
        <h2 id="basic_radiation_safety">Basic Radiation Safety</h2>
        ...
        <p><a name="analytical_xray" id="analytical_xray"></a><h2>On-Site and Analytical X-Ray Safety</h2></p>
                  <p>In order to comply with federal and state regulations, all  individuals at UK  proposing to work with analytical x-ray radiation must register with the  Radiation Safety Office.&nbsp; This is accomplished  by completing the online Analytical X-ray Safety Training. The individual must then bring a copy  of the completed and signed <a href="../docs/pdf/rad_research_onsite_training_form_0001.pdf" target="_top">On-Site X-ray  Safety Training Form</a> and a  completed and signed <a href="../docs/pdf/rad_worker_reg_form_0001.pdf">Radiation Worker Registration  Form</a> to the Radiation  Safety office.</p>
