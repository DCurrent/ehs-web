...
<link rel="stylesheet" href="../libraries/css/style.css" type="text/css" />
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="subContainer">
                ...
                <div id="subNavigation">
                  ...
                  <p>This class is available <a href="main.php?cClassID=117">online</a>.</p>
                  ...
                  <p>Chemical fume                   hoods are the primary engineering   control used in the laboratory                   to protect against the   inhalation of hazardous vapors and gases.                   They are   located in many of the labs across UK&rsquo;s campus. This                     training provides information about the types of fume hoods and                     their function, types of fume hood flow monitors, and   guidelines                   on how to correctly and safely use a fume   hood. Steps to follow                 if your fume hood is not   functioning properly are also included.<br />
                    <br />
        This class is only available <a href="main.php?cClassID=22">online</a>.</p>
        ...
        Classes are held in the Keeneland Room of the William T. Young   Library. </p>
                <p>This class is available  <a href="main.php?cClassID=9">online</a>.</p>
                
                	<h2 id="annual_refresher">Annual refresher</h2>
                	
                    <p>Required  annual refresh of Chemical Hygiene/Laboratory safety.</p>
                	
                    <p>This class is available <a href="main.php?cClassID=7">online</a>.</p>
        ...
        Classroom training sessions are available upon request. Duration is 1 hour.         Contact <a href="main.php?cClassID=30">Lee Poore</a> at (859) 257-2924.</p>
                ...
                <p>The Hazard Communication/GHS is an update to align  with the Globally Harmonized System of Classification and Labeling of Chemicals  (GHS). This update to the Hazard Communication Standard (HCS) will provide a  common and coherent approach to classifying chemicals and communicating hazard  information on labels and safety data sheets.<br />
                  <br />
        This class is only available <a href="main.php?cClassID=75">online</a>.</p>
                <h2 id="heat_stress">Heat Stress Awareness</h2>
                <p>Training                 for employees on heat stress awareness and avoidance.</p>
                <p>This class is only available <a href="main.php?cClassID=28">online</a>.</p>
        ...
        <br />
        Classroom training sessions are available upon request. Contact <a href="main.php?cClassID=30">Lee Poore</a> at (859) 257-2924.</p>
        ...
        <br />
        This class is available <a href="main.php?cClassID=43">online</a>.</p>
