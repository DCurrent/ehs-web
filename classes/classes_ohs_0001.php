    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="subContainer">
                ...
                <div id="subNavigation">
                  ...
                  <ul>
                    <li>Impact                             and Prevalence of Back Injuries</li>
                    <li>Basics                             of Back Anatomy</li>
                    <li>Causes                             of Back Dysfunction</li>
                    <li>Types                             of Back Injuries</li>
        ...
        Classes are held in the Keeneland Room of the William T. Young   Library. </p>
                <p>This class is available  <a href="main.php?cClassID=9" class="link-class">online</a>.</p>
                	...
                	<h2 id="confined_space_entry">Confined Space Entry</h2>
        ...
        Classroom training sessions are available upon request. Duration is 1 hour.         Contact <a href="main.php?cClassID=30">Lee Poore</a> at (859) 257-2924.</p>
                ...
                <p><span xml:lang="EN-US" lang="EN-US">This basic</span><span xml:lang="EN-US" lang="EN-US"> CPR/AED skill</span><span xml:lang="EN-US" lang="EN-US">s</span><span xml:lang="EN-US" lang="EN-US"> course will </span><span xml:lang="EN-US" lang="EN-US">prep</span><span xml:lang="EN-US" lang="EN-US">are</span><span xml:lang="EN-US" lang="EN-US"> you</span><span xml:lang="EN-US" lang="EN-US"> to recognize</span><span xml:lang="EN-US" lang="EN-US"> and respond to emergencies including: obstructed airway, cardiac arrest,</span><span xml:lang="EN-US" lang="EN-US"> </span><span xml:lang="EN-US" lang="EN-US">and </span><span xml:lang="EN-US" lang="EN-US">other </span><span xml:lang="EN-US" lang="EN-US">life-threatening</span><span xml:lang="EN-US" lang="EN-US"> emergencies. Hands on skills will include: </span><span xml:lang="EN-US" lang="EN-US">how to perform the </span><span xml:lang="EN-US" lang="EN-US">abdominal thrusts/back blows</span><span xml:lang="EN-US" lang="EN-US">, </span><span xml:lang="EN-US" lang="EN-US">how to perform CPR on </span><span xml:lang="EN-US" lang="EN-US">an </span><span xml:lang="EN-US" lang="EN-US">adult, </span><span xml:lang="EN-US" lang="EN-US">skills and knowledge needed to provide care for victims of sudden cardiac arrest through the safe use of an automat</span><span xml:lang="EN-US" lang="EN-US">ed external defibrillator (AED).</span></p>
                <p><span xml:lang="EN-US" lang="EN-US">UK Occupational Health &amp; Safety provides training in CPR and AED use free for full-time UK campus employees. To receive training from UK OHS, please contact<a href="mailto:melissa.claar@uky.edu"> Melissa Claar</a></span><a href="mailto:melissa.claar@uky.edu" target="_blank" rel="noreferrer"><span xml:lang="EN-US" lang="EN-US">u</span></a><span xml:lang="EN-US" lang="EN-US">.</span></p>
                
				<h2 id="emergency_eyewash">Emergency Eyewash and Shower Station Use and Inspection</h2>
                <p>Eyewashes and showers are in many locations on campus. This training is   designed to inform workers of when an eyewash and shower station are   required, how they function and how to use them correctly. It also   instructs those who maintain and activate the units in what guidelines   should be followed.<br />
                  <br />
        This class is only available <a href="main.php?cClassID=6" class="link-class">online</a>.</p>
                ...
                <ul>
                  <li>List  at least four methods of fall protection available for protecting workers</li>
        ...
        Classroom training sessions are available upon request. Duration is 1 hour.         Contact <a href="main.php?cClassID=30">Lee Poore</a> at (859) 257-2924.</p>
                ...
                <p>The Hazard Communication/GHS is an update to align  with the Globally Harmonized System of Classification and Labeling of Chemicals  (GHS). This update to the Hazard Communication Standard (HCS) will provide a  common and coherent approach to classifying chemicals and communicating hazard  information on labels and safety data sheets.<br />
                  <br />
        This class is only available <a href="main.php?cClassID=75" class="link-class">online</a>.</p>
                <h2 id="heat_stress">Heat Stress Awareness</h2>
                <p>Training                 for employees on heat stress awareness and avoidance.</p>
                <p>This class is only available <a href="main.php?cClassID=28" class="link-class">online</a>.</p>
                <h2 id="hot_work_program">Hot Work Program</h2>
                <p>The                 University of Kentucky recognizes there is a   potential for fire                 from hot work operations. These   operations are described as those                 work activities   requiring the use of an open flame or from those                   operations that may produce heat or sparks.         This program is implemented to protect UK students, visitors,   employees                 and property from fire resulting from hot work   operations.<br />
                  <br />
        ...
        Classroom training sessions are available upon request. Contact <a href="../Aaron.Offutt@uky.edu">Aaron Offut</a> at (859) 257-3862.</p>
                ...
                <ul>
                  ...
                  <li>Ladder inspection</li>
                  <li>Ladder set up</li>
                  <li>Climbing and standing</li>
                  <li>Proper   ladder use</li>
                  <li>Care and storage</li>
        ...
        This class is available <a href="main.php?cClassID=25" class="link-class">online</a>.                </p>
                ...
                <ul>
                  ...
                  <li>Define  the written utility cart policy including cart operations, charging/refueling,  maintenance/repairs and &nbsp;</li>
