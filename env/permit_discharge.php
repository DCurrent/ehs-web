...
<div id="container">
	...
	<div id="subContainer">
		...
		<div id="content">
			<h1>Kentucky Permit to Discharge from a Small Municipal Seperate Storm Sewer System (MS4)</h1>
            <a href="/docs/pdf/env_ky_sw_discharge_permit_0001.pdf"><img src="/media/image/env_ky_sw_discharge_permit_0001.jpg" alt=""/></a>
		</div>
	</div>
	<div id="sidePanel">		        	
		<?php
