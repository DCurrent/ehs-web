...
<nav id="nav_sub" class="nav_sub">
    <ul id="toplevel"> 
        ...
        <li><a href="#" onclick="return false" class="fly">General Safety</a>
            <ul>
                <li><a href="/ohs/accident.php">Accident Reporting</a></li>
                <li><a href="/ohs/agsafety.php">Agricultural Safety</a></li>
                <li><a href="/docs/pdf/ohs_aerial_lift_safety_program_0001.pdf" target="_blank">Aerial Lift Safety Program</a></li>
                <li><a href="/ohs/cgc2.html">Compressed Gas Cylinders</a></li>
                <li><a href="/docs/pdf/ohs_confined_space_program_0001.pdf" target="_blank">Confined Space Entry Program</a></li>
        ...
        <li><a href="/ohs/indhyg.php" class="fly">Industrial Hygiene</a>
          <ul>
            <li><a href="/ohs/indhyg.php">Overview</a></li>
            <li><a href="/ohs/ih_asbestos.php">Asbestos</a></li>
            <li><a href="/ohs/bb_pathogens.php">Bloodborne Pathogens</a></li>
            <li><a href="/ohs/hearcons.php">Hearing Conservation</a></li>
            <li><a href="/ohs/air.php">Indoor Air Quality</a></li>
            <li><a href="/ohs/ih_lead.php">Lead</a></li>
            <li><a href="/ohs/ih_monitoring.php">Monitoring</a></li>
            <li><a href="/ohs/ih_nr_exposure.php">Non-Routine Exposures</a></li>
            <li><a href="/ohs/radon.php">Radon</a></li>
            <li><a href="/ohs/respgate.php">Respiratory Protection</a></li>
          </ul>
        </li>
      
        <li><a href="#" onclick="return false" class="fly">Information</a>
            <ul>
                <li><a href="/ohs/dod.php">DOD Grant</a></li>                
                <li><a href="/ohs/intres.html">Other Resources</a></li>
                <li><a href="/docs/xls/bio_pi_req_matrix.xls" target="_blank">PI Requirements Matrix</a></li>
                <li><a href="/docs/pdf/ep_factsheet_surplus_0001.pdf" target="_blank">Surplusing Lab And Medical Equipment</a></li>
            </ul>
        </li>
      	
        <li><a href="/ohs/injury.php">Injury/Illness Statistics</a></li>
        
        <li><a href="#" onclick="return false" class="fly">Laboratory Safety</a>
            <ul>
                ...
                <li><a href="#">Lab Inspection Procedures</a>
                  <ul>
                    ...
                    <li><a href="/docs/pdf/ohs_chp_violation.pdf" target="_blank">Violations</a></li>
                  </ul>
                </li>
        ...
        <li><a href="#" onclick="return false" class="fly">Passenger Van</a>
          <ul>
            <li><a href="/docs/pdf/ohs_van_alert.pdf" target="_blank">Passenger Van Alert</a></li>
            <li><a href="//www.nhtsa.gov/About+NHTSA/Press+Releases/2012/Consumer+Advisory:+NHTSA+Offers+Tips+for+Safe+Travel+in+15-Passenger+Vans" target="_blank">Passenger Van Consumer Advisory</a></li>            
            <li><a href="//www.cbsnews.com/stories/2002/04/17/60II/main506479.shtml">CBS News Rollover</a></li>
            <li><a href="//www.safercar.gov/Vehicle+Shoppers/Passenger+Van+Safety" target="_blank">Passenger Van Safety</a></li>
