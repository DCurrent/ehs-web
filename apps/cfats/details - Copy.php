<?php 
	...
	if($query->get_row_exists()) $details = $query->get_line_object();
	...
	{	
		...
		$query->set_sql('SELECT label
							...
							WHERE     (id = ?)');
		$query->set_params(array(&$details->type));
		$query->query();
		...
		$query->set_sql('SELECT name
							...
							WHERE     (number = ?)');
		$query->set_params(array(&$details->department));
		$query->query();
		...
		$query->set_sql('SELECT name
							...
							WHERE     (code = ?)');
		$query->set_params(array(&$details->facility));
		$query->query();
		...
		$query->set_sql('SELECT room, useage_desc
							...
							WHERE     (barcode = ?)');
		$query->set_params(array(&$details->area));
		$query->query();
		
		if($query->get_row_exists()) $room = $query->get_line_object();
		...
		$query->set_params(array(&$details->id));
		$query->query();
					...
					?>         	       						
                        <table class="spaced">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>Name</th>
                                    <td><?php echo $details->name_l.', '.$details->name_f; ?></td>
                                </tr>
                                
                                <tr>
                                    <th>Account</th>
                                    <td><?php echo $details->account; ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<?php 
											...
											{
										?>
                                    			<a href="mailto:<?php echo $details->email; ?>" title="Click to send email."><?php echo $details->email; ?></a></td>
                                        <?php
											}
										?>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                            ...
                                            {
                                                if($room) echo ', '.$room->room.' ('.ucwords(strtolower($room->useage_desc)).')';
                                            }									
                                        ?>
                                    </td>
                                </tr>
