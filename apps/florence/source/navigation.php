<?php
	...
	{
		const DIRECTORY_PRIME = '/apps/florence';
		...
		?>
            ...
            <div id="nav_footer" class="container well" style="width:95%; margin-top:20px;">
            	<a href="https://www.caskeys.com"><img src="<?php echo $this->directory_prime; ?>/media/uk_logo_1.png" alt="Caskeys Inc" style="float:left; margin-top:10px; margin-bottom:5px;"></a>
