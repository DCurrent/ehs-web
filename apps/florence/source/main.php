<?php
	...
	$application_config = parse_ini_file("config_local.ini", TRUE);
	...
	// Get basic application config. Will most likely be
	// read in again during class registration.
	$application_config = parse_ini_file("config_local.ini", TRUE);
    ...
    spl_autoload_register('app_load_class');
		...
		$yukon_connect_config->set_db_type($application_config["database"]["db_type"]);
		$yukon_connect_config->set_host($application_config["database"]["host"]);
		$yukon_connect_config->set_name($application_config["database"]["name"]);
		$yukon_connect_config->set_user($application_config["database"]["user"]);
		$yukon_connect_config->set_password($application_config["database"]["password"]);
