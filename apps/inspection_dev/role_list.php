<?php 
	...
	$query->set_sql('{call role_list(@page_current 		= ?,														 
										@page_rows 			= ?,
										@page_last 			= ?,
										@row_count_total	= ?)}');
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <div class="page-header">
                <h1>Roles</h1>
                <p>Roles define how a user interacts with the application. Available roles are listed here.</p>
            </div>
            
            <a href="role.php&#63;nav_command=<?php echo RECORD_NAV_COMMANDS::NEW_BLANK; ?>" class="btn btn-success btn-block" title="Click here to start entering a new role."><span class="glyphicon glyphicon-plus"></span> New Role</a>
                        ...
                        <?php
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a	href		="role.php&#63;id=<?php echo $_obj_data_main->get_id(); ?>" 
                                            class		="btn btn-info"
