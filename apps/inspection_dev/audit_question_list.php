<?php 
	...
	$query->set_sql('{call audit_question_list(@page_current 	= ?,														 
										@page_rows 			= ?,										
										@update_from		= ?,
										@update_to			= ?,
										@finding			= ?,
	...
	$params = array(array($paging->get_page_current(), 	SQLSRV_PARAM_IN), 
					...
					array($filter->get_finding(),		SQLSRV_PARAM_IN),
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <div class="page-header">
                <h1>Audit Question List</h1>
                <p>This is a list of audit questions/findings to be sighted during inspections.</p>
            </div>
            ...
            <a href="audit_question.php&#63;nav_command=<?php echo RECORD_NAV_COMMANDS::NEW_BLANK;?>&amp;id=<?php echo DB_DEFAULTS::NEW_GUID; ?>" class="btn btn-success" title="Click here to start entering a new item."><span class="glyphicon glyphicon-plus"></span> Item</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><a href="<?php echo $sorting->sort_url(2); ?>">Finding <?php echo $sorting->sorting_markup(2); ?></a></th>
                            <!--<th><a href="<?php //echo $sorting->sort_url(3); ?>">Action <?php //echo $sorting->sorting_markup(3); ?></a></th>-->                                  
                        ...
                        <?php
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <!--<td><?php //echo $_obj_data_main->get_action(); ?></td>-->
                                            ...
                                            <td><a	href	="<?php echo 'audit_question.php&#63;id='.$_obj_data_main->get_id(); ?>" 
                                                    class		="btn btn-info"
