<?php 
	...
	$request = new blair_class_common_data();
	
	// Record navigation.
	$obj_navigation_rec = new class_record_nav();
	
	$query->set_sql('{call log_list(@page_current 		= ?,														 
										@page_rows 			= ?,
										@update_id			= ?)}');	
	...
	$query->get_line_params()->set_class_name('blair_class_log_data');
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <div class="page-header">
                <h1>Log</h1>
                <p>The following is a log of update events for this record.</p>
            </div>
                        ...
                        <?php
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><?php if(is_object($_obj_data_main->get_update_time()) === TRUE) echo date(APPLICATION_SETTINGS::TIME_FORMAT, $_obj_data_main->get_update_time()->getTimestamp()); ?></td>
                                        </tr>                                    
                            <?php								
                            	}
							}
