<?php 
	...
	{		
		...
		case RECORD_NAV_COMMANDS::LISTING:
			...
			// Direct to listing.				
			header('Location: audit_question_inclusion_list.php');
			break;
...
<html lang="en">
    <head>
        ...
        <title><?php echo APPLICATION_SETTINGS::NAME; ?>, Inclusion Detail</title>        
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <div class="page-header">           
                <h1>Audit Question Inclusion Entry<?php if($_main_data->get_label()) echo ' - '.$_main_data->get_label(); ?></h1>
                <p>This screen allows for adding and editing inclusion items for audit questions.</p>
            </div>
