<?php
	...
	class blair_class_common_inspection_data extends blair_class_common_data
	{	
		protected
			$room_id			= NULL,
			$room_code			= NULL,
	...
	class class_inspection_autoclave_detail_data extends blair_class_common_inspection_data
	{
		private
			$biowaste		= NULL,
			$maker			= NULL,
		...
		public function xml()
		{
			...
			{
				$this->id[0] = DB_DEFAULTS::NEW_GUID;
			}
	...
	class class_inspection_visit_data extends blair_class_common_data
	{
		private
			$visit_type = NULL,
			$visit_by	= NULL;
		...
		public function xml()
		{
			...
			foreach($this->id as $key => $id)
			{
				...
				if($visit_by == NULL) 	$visit_by 	= DB_DEFAULTS::NEW_GUID;
				if($visit_type == NULL) $visit_type = DB_DEFAULTS::NEW_GUID;
	...
	class class_inspection_party_data extends blair_class_common_data
	{
		private
			$party	= NULL;
		...
		public function xml()
		{
			...
			{	
				...
				if($party == NULL) $party = DB_DEFAULTS::NEW_GUID;
	...
	class class_inspection_saa_detail_data extends blair_class_common_inspection_data
	{
		private
			$area 		= NULL,
			$correction	= NULL;
		...
		public function xml()
		{
			...
			foreach($this->id as $key => $id)
			{
				...
				if($area == NULL) 		$area 		= DB_DEFAULTS::NEW_GUID;
				if($correction == NULL) $correction = DB_DEFAULTS::NEW_GUID;
		...
		public function set_sub_saa_detail_area($value)
		{
			$this->area = $value;
		}
	...
	class class_inspection_saa_correction_data extends blair_class_common_data
	{
		private
			$area_label	= NULL,
			$order	= NULL;
	...
	class blair_class_audit_question_data extends blair_class_common_data
	{
		private
			$finding 			= NULL,
	...
	class blair_class_audit_question_category_data extends blair_class_common_data
	{
		private
			$fk_id		= NULL;
	...
	class blair_class_audit_question_inclusion_data extends blair_class_common_data
	{
		private
			$fk_id		= NULL;
	...
	class blair_class_audit_question_rating_data extends blair_class_common_data
	{
		private
			$fk_id		= NULL;
	...
	class blair_class_audit_question_reference_data extends blair_class_common_data
	{
		private
			$fk_id		= NULL;
