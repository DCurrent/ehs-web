<?php 
	...
	$query->set_sql('{call account_group_list(@page_current 		= ?,														 
										@page_rows 			= ?,
										@page_last 			= ?,
										@row_count_total	= ?)}');
	...
	$query->get_line_params()->set_class_name('blair_class_group_data');
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <div class="page-header">
                ...
                <p>Create account groups for mass emails, role assignments, etc.</p>
            </div>
            
            <a href="account_group.php&#63;nav_command=<?php echo RECORD_NAV_COMMANDS::NEW_BLANK; ?>" class="btn btn-success btn-block" title="Click here to start entering a new group."><span class="glyphicon glyphicon-plus"></span> New Group</a>
                        ...
                        <?php
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a	href		="account_group.php&#63;id=<?php echo $_obj_data_main->get_id(); ?>" 
                                            class		="btn btn-info"
