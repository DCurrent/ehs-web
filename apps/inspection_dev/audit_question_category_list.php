...
<html lang="en">
    ...
    <body>    
        <div id="container" class="container">            
            ...
            <a href="audit_question_category.php&#63;nav_command=<?php echo RECORD_NAV_COMMANDS::NEW_BLANK;?>&amp;id=<?php echo DB_DEFAULTS::NEW_GUID; ?>" class="btn btn-success btn-block" title="Click here to start entering a new item."><span class="glyphicon glyphicon-plus"></span> New Category</a>
                        ...
                        <?php
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a	href		="audit_question_category.php&#63;id=<?php echo $_obj_data_main->get_id(); ?>" 
                                            class		="btn btn-info"
