    ...
    <body>    
        <div id="container" class="container">            
            ...
            <div class="page-header">
                <h1>Audit Question Ratings</h1>
                <p>List of rating categories for audit questions.</p>
            </div>
            
            <a href="audit_question_rating.php&#63;nav_command=<?php echo RECORD_NAV_COMMANDS::NEW_BLANK;?>&amp;id=<?php echo DB_DEFAULTS::NEW_GUID; ?>" class="btn btn-success btn-block" title="Click here to start entering a new item."><span class="glyphicon glyphicon-plus"></span> New Rating</a>
                        ...
                        <?php
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td><a	href		="audit_question_rating.php&#63;id=<?php echo $_obj_data_main->get_id(); ?>" 
                                            class		="btn btn-info"
