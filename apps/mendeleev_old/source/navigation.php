                    ...
                    <div class="collapse navbar-collapse" id="nav_main">
                        <ul class="nav navbar-nav">
                            ...
                            <?php
								...
								{
									?>
                                    <li><a href="<?php echo $this->directory_prime; ?>/area_update.php" href="#">Area Update</a></li>
                                    <?php
								}
							
								if($this->access_obj->get_account() == 'dvcask2' || $this->access_obj->get_account() == 'trobert')
								{
									?>
