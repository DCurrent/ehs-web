                ...
                <table class="table table-striped table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><a href="<?php echo $sorting->sort_url(5); ?>">PI <?php echo $sorting->sorting_markup(5); ?></th>
                            <th><a href="<?php echo $sorting->sort_url(4); ?>">Facility <?php echo $sorting->sorting_markup(4); ?></th>
                            <th>Areas</th>
                        </tr>
                    </thead>
                    <tfoot>
                    ...
                    <tbody>                        
                        <?php
                            ...
                            ?>
                                        <tr class="clickable-row" role="button" data-href="audit_question_category.php?id=<?php echo $_obj_data_main->get_id(); ?>">
                                            ...
                                            <td><?php echo $_obj_data_main->get_facility(); ?></td>
