    ...
    <body>    
        <div id="container" class="container">            
            ...
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">           
				...
				<div class="form-group pickup-address-container"> 
					<label class="control-label col-sm-2" for="address"></label>
					<div class="col-sm-10">                   	  
                   	  <p>&nbsp;</p>
                       	<p>
							<!--span class=".small"> Please enter a UK campus address.</span -->
                       	  	<span class=".small">Please tell us your campus address to send you LED slap bracelet to for making an observation.</span>
							<br />
                       	  &nbsp;
