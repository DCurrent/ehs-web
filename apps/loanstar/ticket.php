...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../waukegan - Copy/source/css/style.css" />
        <link rel="stylesheet" href="../waukegan - Copy/source/css/print.css" media="print" />
									...
									?>
											<tr>
                                                ...
                                                <td>
													 <input 	type="text"                                                        	 
														name	="sub_party_name[]" 
														id		="sub_party_name_<?php echo $_obj_data_sub_party->get_id(); ?>" 
										...
										?>
											<tr>
												<td>                                                    	
													<textarea                                                  	 
														name	="sub_details[]" 
														id		="sub_details_<?php echo $_obj_data_sub->get_id(); ?>" 
														class	="form-control"><?php echo $_obj_data_sub->get_details(); ?></textarea>
												</td>  
                                                ...
                                                <td>   
													...
													<input 	type="text"                                                        	 
														name	="sub_log_account[]" 
														id		="sub_log_account_<?php echo $_obj_data_sub->get_id(); ?>" 
														class	="form-control" 
														readonly
														value 	= "<?php echo $lookup->get_account_data()->name_proper(); ?>">
												</td>
												...
												<td>                                                    	
													<input 	type="text"                                                        	 
														name	="sub_log_update[]" 
														id		="sub_log_update_<?php echo $_obj_data_sub->get_id(); ?>" 
														class	="form-control" 
														readonly
														value 	= "<?php if($_obj_data_sub->get_log_update()) echo date(APPLICATION_SETTINGS::TIME_FORMAT, $_obj_data_sub->get_log_update()->getTimestamp()); ?>">
												</td>
		...
		{						
			$(".ec").append(
				'<tr>'
					...
					+'</td>'
					+'<td>'				
						+'<input type="text" name="sub_log_account[]" id="sub_log_account_'+ $temp_int + '" class="form-control" readonly value="<?php echo $lookup->get_account_data()->name_proper(); ?>">'												
					+'</td>'
					+'<td>'				
						+'<input type="text" name="sub_log_update[]" id="sub_log_update_'+ $temp_int + '" class="form-control" readonly value="">'												
					+'</td>'															
					+'<td colspan="2">'
