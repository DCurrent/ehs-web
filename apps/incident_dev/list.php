                        ...
                        <tbody>         
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a mailto="<?php echo $incident->get_email(); ?>"><?php echo $incident->get_name_l().', '.$incident->get_name_f(); ?></a></td>                                    	<td><a href="../incident - Copy/details.php?id=<?php echo $incident->get_id(); ?>" target="new">Details</a></td>
                                                </tr>                                            
                                        <?php
                                            }
                                        ?>
