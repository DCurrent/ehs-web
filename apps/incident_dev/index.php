                        	...
                        	<fieldset class="center">
                                ...
                                ?>
                                    	<span style="white-space:nowrap;">		
                                            <input type="radio" 
                                                name="type" 
                                                id="type_<?php echo $type_row->get_id(); ?>" 
                                                value="<?php echo $type_row->get_id(); ?>" required />
                                            <label for="type_<?php echo $type_row->get_id(); ?>"><?php echo $type_row->get_label(); ?></label>
                                        </span>                                  
                                	...
                                	<div>                                  
                                        ...
                                        <div class="fieldset_box">   
                                            ...
                                            <input type="radio" 
                                                ...
                                                required <?php if(!$post->get_contact()) echo 'checked'; ?> />
